...
public sealed class ManageV1ProjectsUsageBreakdown
{
    ...
    /// <param name="grouping">Common usage grouping parameters</param>
    ...
    /// <exception cref="SdkException{TResult}"> of <see cref="Get9Error"/> when the server returns an error response.</exception>
    /// <remarks>
    /// Retrieves the usage breakdown for a specific project, with various filter options by API feature or by groupings. Setting a feature (e.g. diarize) to true includes requests that used that feature, while false excludes requests that used it. Multiple true filters are combined with OR logic, while false filters use AND logic.
    /// </remarks>
    public Task<UsageBreakdownV1Response> Get9(string projectId,
        DateTimeOffset? start,
        DateTimeOffset? end,
        V1ProjectsProjectIdUsageBreakdownGetParametersGrouping? grouping,
        string? accessor,
        bool? alternatives,
        bool? callbackMethod,
        bool? callback,
        ...
        bool? customTopic,
        V1ProjectsProjectIdUsageBreakdownGetParametersDeployment? deployment,
        bool? detectEntities,
        bool? detectLanguage,
        bool? diarize,
        bool? dictation,
        bool? encoding,
        V1ProjectsProjectIdUsageBreakdownGetParametersEndpoint? endpoint,
        bool? extra,
        bool? fillerWords,
        bool? intents,
        bool? keyterm,
        ...
        bool? language,
        bool? measurements,
        V1ProjectsProjectIdUsageBreakdownGetParametersMethod? method,
        string? model,
        bool? multichannel,
        bool? numerals,
        bool? paragraphs,
